...
class DynamicDenseCL(BaseSSLearner):
    '''DynamicDenseCL.
    ...
    def __init__(self,
                 ...
                 loss_lambda=0.5,
                 same_arch=False,
                 max_last_channel=2560,
                 **kwargs):
        super(DynamicDenseCL, self).__init__()
        ...
        #self.adaptive_conv = DynamicConv2d(max_last_channel,max_last_channel,
