...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=128,
        with_avg_pool=True),
    head=dict(type='ContrastiveHead_learnable', temperature=0.2))
# dataset settings
data_source_cfg = dict(
    type='ImageNet',
    memcached=True,
    mclient_path='/mnt/lustre/share/memcached_client')
_data_root_ = '/data1/changqing/Data/imagenet'
...
# runtime settings
total_epochs = 200
work_dir = '/data2/qing_chang/OpenSelfSup-gaia/workdirs/moco/moco_r50_myself_run/learnable_sigma_clipvalue'
